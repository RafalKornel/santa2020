...
reg_name = Regexp("^[a-zA-ZąćęłńóśźżĄĘŁŃÓŚŹŻ ]*$", message="Name can only contain letters and spaces.")
reg_PIN = Regexp("^[0-9]{4}$", message="PIN is 4 digits.")
reg_group = Regexp("^[a-zA-Z0-9ąćęłńóśźżĄĘŁŃÓŚŹŻ _-]*$", message="Group name can only contain letters, numbers or '_' and '-'.")
